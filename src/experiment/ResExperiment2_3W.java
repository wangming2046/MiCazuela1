...
// The results of 30 simulation runs to show CI's similar to Table 5.2
// from the text book

public class ResExperiment2_3W
{
   public static void main(String[] args)
   {
       ...
       // Case 1
       System.out.println("Case 1 - 4 large table, 3 small table, 3 waiters and 2 cooks");
       for(i=0 ; i < NUMRUNS ; i++)
       {
       ...
       // Case 2
       System.out.println("Case 2 - 5 large table, 1 small table, 3 waiters and 2 cooks");
       for(i=0 ; i < NUMRUNS ; i++)
       {
           model = new Restaurant(START_TIME,END_TIME, 5, 3, 2, sds[i], false);
           model.runSimulation();
       ...
       // Case 3
       System.out.println("Case 3 - 3 large table, 5 small table, 3 waiters and 2 cooks");
       for(i=0 ; i < NUMRUNS ; i++)
       {
       ...
       // Case 4
       System.out.println("Case 4 - 2 large table, 7 small table, 3 waiters and 2 cooks");
       for(i=0 ; i < NUMRUNS ; i++)
       {
           model = new Restaurant(START_TIME,END_TIME, 2, 3, 2, sds[i], false);
           model.runSimulation();
       ...
       System.out.printf("   Run  Profit WaiterUtilization CookUtilization PerWaitParty PerBalkParty \n");
       System.out.printf("------------------------------------------------------------------------\n");
       // Simulation values
       for(i = 0; i < NUMRUNS; i++)
