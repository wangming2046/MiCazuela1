	...
	// Some constants for experimentation
	  ...
	  /** main method **/
	   public static void main(String[] args)
	   {
	       ...
	       // Case 1
	       runRestaurant1Sim("Case 1" , 4, 2, 2, sds);
	       // Case 2
	       runRestaurant1Sim("Case 2" , 5, 2, 2, sds);
	       // Case 3
	       runRestaurant1Sim("Case 3" , 3, 2, 2, sds);
	       // Case 4
	       runRestaurant1Sim("Case 4" , 2, 2, 2, sds);
	       ...
	       for(int i = 0 ; i< numRuns; i++) 
	    	   {
	    	   		runRestaurant1Sim("Case 1" , 4, 2, 2, sdsArr[i]);
	    	   }
	   }
